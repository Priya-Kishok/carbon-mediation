...
/**
  Throttle Mediator Test - This class test throttling when policy has specified as both of InLine and a registry key
 */
    ...
    public class ThrottleTestMediator extends AbstractMediator {
        ...
        protected boolean canAcess(MessageContext synContext)
            ...
            if (remoteIP == null) {
                ...
                boolean canAccess = accessInformation.isAccessAllowed();
                if (!canAccess) {
        ...
        protected void init(MessageContext synContext) {
            ...
            boolean reCreate = false; // No need to recreate ,if property is not dyanamic
            ...
            if (policyKey != null) {
                ...
                // if entry is dynamic, need to check whether updated or not
